    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          ...
          contentText(
              """$legalName ("us", "we", or "our") operates the {this.url} website ${mobile != null ? 'and the $mobile mobile application' : ''} (the "Service")."""),
          ...
          listItem(null, "To provide and maintain the Service"),
          listItem(null, "To notify you about changes to our Service"),
          listItem(null,
              "To allow you to participate in interactive features of our Service when you choose to do so"),
          listItem(null, "To provide customer care and support"),
          listItem(null,
              "To provide analysis or valuable information so that we can improve the Service"),
          listItem(null, "To monitor the usage of the Service"),
          listItem(null, "To detect, prevent and address technical issues"),
          listItem(null,
          ...
          contentText("""$legalName may process your Personal Data because:"""),
          listItem(null, "We need to perform a contract with you"),
          listItem(null, "You have given us permission to do so"),
          listItem(null,
              "The processing is in our legitimate interests and it's not overridden by your rights"),
          listItem(null, "For payment processing purposes"),
          listItem(null, "To comply with the law"),
          ...
          listItem(null, "To comply with a legal obligation"),
          listItem(null,
          ...
          listItem(null, "To protect against legal liability"),
